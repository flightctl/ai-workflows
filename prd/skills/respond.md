...
```bash
python3 "$PR_COMMENTS_SCRIPT" log --responses-log .artifacts/prd/{issue-key}/responses.jsonl --comment-id {id from fetch output} --response-summary "{brief summary of response}"
```
