...
```bash
python3 "$PR_COMMENTS_SCRIPT" log --responses-log .artifacts/implement/{issue-key}/responses.jsonl --comment-id {comment-id} --response-summary "{brief summary of response}"
```
