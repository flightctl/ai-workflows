...
| Design | `/draft` | Draft design document and testplan | `03-design.md`, `04-testplan.md` |
| Decompose | `/decompose` | Break into epics and stories | `05-epics.md`, `06-stories/`, `07-coverage.md` |
| Revise | `/revise` | Incorporate feedback | Updated design, testplan, and/or stories |
| Publish | `/publish` | Post design doc and testplan as GitHub PR | `08-pr-description.md` |
| Respond | `/respond` | Address reviewer comments | `09-review-responses.md`, updated design / testplan / stories |
...
/draft
  ...
  → generates testplan anchored to PRD requirements and interface changes
  → writes 03-design.md, 04-testplan.md

/decompose
  → breaks design into epics and stories
  → maps stories to interface changes (ICs) and test cases (TCs)
  → validates coverage against PRD requirements
  → writes 05-epics.md, 06-stories/ (epics + stories), 07-coverage.md
...
/respond
  ...
  → cascades testplan changes to story Validated by references
  → repeatable
...
Epic and story files live under `06-stories/`. Each file maps 1:1 to a
Jira issue:
...
.artifacts/design/EDM-2324/
  ...
  03-design.md
  04-testplan.md                       (generated by /draft)
  05-epics.md                          (metadata: ordering, dependencies)
  06-stories/
